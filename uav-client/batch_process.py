    ...
    while True:
        ...
        for file_name in file_list:
            ...
            try:
                ...
                cmd = "./darknet detector test cfg/voc-kmeans.data cfg/yolov4-custom-kmeans.cfg backup/yolov4-custom-kmeans_10000.weights " + file_name + " -thresh .1";
...
def file_transfer(config):
    cmd = "java -jar uav-client.jar -h " + config.get_server_host() + " -p " + config.get_server_port() + " -f ./data/result -n TX2 -c 1024";
    print("文件传输程序已启动：" + cmd + "\n");
    subprocess.call(cmd, shell=True);
